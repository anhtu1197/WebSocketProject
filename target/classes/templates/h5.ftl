...
<div class="container">
    ...
    <div class="content">
        <div class="content_top">
            <div class="tips"></div>
            <span class="openHistory">Lịch sử</span>
        </div>
        ...
        <form>
            <textarea class='msg' type="text" name="message" placeholder='Gửi tin nhắn' value=""></textarea>
            <input class="btn" type="button" value="Gửi" onclick="send(this.form.message.value)"/>
...
<script>
    ...
    msg = msg+'<div>--- Trên này là lịch sử ---</div>';
</script>
</html>