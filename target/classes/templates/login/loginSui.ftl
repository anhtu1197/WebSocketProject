    ...
    <div class="page page-current" id="router">
        ...
        <div class="content">
                        ...
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    <div class="item-title label">Mã số tài khoản</div>
                ...
                <div class="content-block">
                    <div class="row">
                        <div class="col-50"><a href="#" id="login" class="button button-big button-fill button-danger" onclick="loginBtn()">Đăng nhập</a></div>
                        <div class="col-50"><a href="#router3" class="button button-big button-fill button-success">Đăng ký</a></div>
                    </div>
                </div>
        </div>
        <!-- 你的html代码 -->
    ...
    <div class="page" id='router3'>
        ...
        <div class="content">
            <div class="content-block">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="item-content">
                                <div class="item-media"><i class="icon icon-form-name"></i></div>
                                <div class="item-inner">
                                    <div class="item-title label">Account number</div>
                                    <div class="item-input">
                ...
                <div class="content-block">
                    <div class="row">
                        <div class="col-50"><a href="#" class="button button-big button-fill button-danger" onclick="regist()">Đăng ký thành công</a></div>
                        <div class="col-50"><a href="#" class="button button-big button-fill button-success back">Trở về</a></div>
                    </div>
                </div>
